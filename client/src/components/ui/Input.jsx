  ...
  return (
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <input
        ...
        ref={ref}
        className={cn(
          "w-full bg-[#f2f2f7] border border-black/20 rounded-2xl px-4 py-3 text-sm text-[#1d1d1f]",
          "placeholder:text-gray-400",
          "focus:outline-none focus:bg-white focus:border-black/60 focus:ring-4 focus:ring-black/5",
  ...
  return (
    <div className="flex flex-col gap-1.5 w-full">
      ...
      <select
        ...
        ref={ref}
        className={cn(
          "w-full bg-[#f2f2f7] border border-black/20 rounded-2xl px-4 py-3 text-sm text-[#1d1d1f] appearance-none",
          "focus:outline-none focus:bg-white focus:border-black/60 focus:ring-4 focus:ring-black/5",
          "transition-all duration-300 ease-out",
...
export function QtyInput({ className, ...props }) {
  return (
    <input
      ...
      min="0"
      className={cn(
        "w-full bg-[#f2f2f7] border border-black/20 rounded-xl px-3 py-2 text-sm text-center text-[#1d1d1f]",
        "focus:outline-none focus:bg-white focus:border-black/60 focus:ring-4 focus:ring-black/5",
        "transition-all duration-300 ease-out",
        className
      )}
